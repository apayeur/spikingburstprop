/***********************************************************
 ...
 event-dependent plasticity rule with adaptive A_plus and
 A_minus.
...
int main(int ac, char* av[])
{
    ...
    double simtime = 1800;
    std::string connect_type = "AdaptiveEBCP";
    string simname = "test_adaptive_ebcp";
    std::string dir = ".";
    ...
    AdaptiveEBCPConnection * con_ext_soma = new AdaptiveEBCPConnection(input, neurons_exc, we_soma,
