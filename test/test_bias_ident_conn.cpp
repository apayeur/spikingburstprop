/***********************************************************
 Description: This program tests the bias identity connection.
 ************************************************************/
...
int main(int ac, char* av[])
{
    ...
    string simname = "test_bias_ident_conn";
    std::string dir = ".";
    ...
    // Input group
    PoissonGroup * poisson_soma = new PoissonGroup(1000, 300.);
    ...
    BiasConnection * con_ext_soma = new BiasConnection(input,
                                                       ...
                                                       we_soma,
                                                       sparseness,
                                                       learning_rate, max_weight);
    */
    BiasIdentityConnection * con_ext_soma = new BiasIdentityConnection(poisson_soma, neurons_exc, w0, learning_rate, GLUT);
    con_ext_soma->set_max_weight(5.);
