...
ax_normal.annotate('b', (-0.5, 1), xycoords='axes fraction')
...
ax_finite_size.annotate('d', (-0.5,1), xycoords='axes fraction')
...
ax_no_hidden_plasticity.annotate('c', (-0.4,1), xycoords='axes fraction')
...
ax_random_examples.annotate('e', (-0.4,1), xycoords='axes fraction')
sns.despine(ax=ax_random_examples, bottom=True, trim=True)

plt.tight_layout()
plt.savefig('../../results/xor/FigureS3.pdf')
plt.close()